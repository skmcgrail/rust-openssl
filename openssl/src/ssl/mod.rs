...
bitflags! {
    ...
    pub struct SslOptions: SslOptionsRepr {
        ...
        #[cfg(any(boringssl_flavour, ossl110h))]
...
cfg_if! {
    if #[cfg(any(boringssl_flavour, ossl110, libressl291))] {
